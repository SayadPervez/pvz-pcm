...
export class Filter {
    ...
    generateOutput() {
        ...
        let val = wave1;
        if (wave1 instanceof DSBFC) {
            let lower = wave1.dsbsc.sidebands[0];
            let upper = wave1.dsbsc.sidebands[1];
            val = lower;
        } else if (wave1 instanceof DSBSC) {
            let lower = wave1.sidebands[0];
            let upper = wave1.sidebands[1];
            val = lower;
        }
